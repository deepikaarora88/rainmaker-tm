...
import org.egov.tm.contract.Address;
import org.egov.tm.contract.MigrationCriteria;
...
import org.egov.tm.repository.rowmapper.ActionInfoRowMapper;
import org.egov.tm.repository.rowmapper.AddressRowMapper;
...
public class MigrationService {
    ...
    @Autowired
    public MigrationService( GrievanceService grievanceService) {
    ...
    public void migrateData(RequestInfo requestInfo, MigrationCriteria migrationCriteria){
        ...
        for(String tenantId : tenantIds){
            ...
            while (true){
                ...
                List<Services> services = jdbcTemplate.query(finalQuery, preparedStmtList.toArray(), svcRowMapper);
    ...
    public Map<String, Address> fetchAddressIdToAddressMap(List<String> ids){
    ...
    public Map<String, ActionHistory> fetchServiceRequestIdToActionHistoryMap(List<String> ids){
        ...
        fetchActions.append(createQuery(ids)).append(") order by \"createdby\" desc");
